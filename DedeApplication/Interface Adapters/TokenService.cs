...
namespace DedeApplication.Frameworks_Drivens
{
    public class TokenService : ITokenService
    {
        ...
        public string GeneratorToken()
        {
            ...
            string Audience = "DedeApplication"; //Quem consome o token
       ...
       /* public string DecryptToken(string UserToken) {
            JwtSecurityTokenHandler jwtSecurityTokenHandler = new JwtSecurityTokenHandler(); 
            var JwtSecurityToken = jwtSecurityTokenHandler.ReadJwtToken(UserToken); 
